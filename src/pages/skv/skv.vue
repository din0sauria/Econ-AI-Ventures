...
.search-box {
    ...
    border-radius: 4px;
    overflow: hidden;
    border: 1px solid #ABBDFF; /* 修改边框颜色为橙色 */
    background-color: #F7F9FF; /* 修改背景颜色为淡粉色 */
}
...
.el-select {
  border: 1px solid #ABBDFF; /* 修改边框颜色为橙色 */
  background-color: #ABBDFF; /* 修改背景颜色为淡粉色 */
  border-radius: 6px;
}

.el-select .el-input__inner {
  background-color: inherit; /* 让输入框内部背景继承父元素颜色 */
}
