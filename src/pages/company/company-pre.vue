                    ...
                    <el-row :gutter="20">
                        <el-col :span="6">
                            <el-upload class="upload-demo" action="https://jsonplaceholder.typicode.com/posts/"
                                :limit="1" :file-list="form.businessLicense">
                                <el-button type="primary">点击上传</el-button>
                                <template #tip>
                                    <div class="el-upload__tip">营业执照</div>
                                    <div class="el-upload__tip">请上传企业营业执照扫描件，需在有效期</div>
                                </template>
                            </el-upload>
                        </el-col>
                        ...
                        <el-col :span="6">
                            <el-upload class="upload-demo" action="https://jsonplaceholder.typicode.com/posts/"
                                :limit="1" :file-list="form.legalIdCard">
                                <el-button type="primary">点击上传</el-button>
                                <template #tip>
                                    <div class="el-upload__tip">法人身份证明</div>
                                    <div class="el-upload__tip">请上传法人身份证正反面扫描件；若为非法人本人办理，需上传法人授权委托书及经办人身份证正反面扫描件</div>
                                </template>
                            </el-upload>
                        </el-col>
                        ...
                        <el-col :span="6">
                            <el-upload class="upload-demo" action="https://jsonplaceholder.typicode.com/posts/"
                                :limit="1" :file-list="form.taxRegistration">
                                <el-button type="primary">点击上传</el-button>
                                <template #tip>
                                    <div class="el-upload__tip">税务登记证</div>
                                    <div class="el-upload__tip">如三证合一可不填；若非三证合一请上传税务登记证扫描件</div>
                                </template>
                            </el-upload>
                        </el-col>
                        ...
                        <el-col :span="6">
                            <el-upload class="upload-demo" action="https://jsonplaceholder.typicode.com/posts/"
                                :limit="1" :file-list="form.organizationCode">
                                <el-button type="primary">点击上传</el-button>
                                <template #tip>
                                    <div class="el-upload__tip">组织机构代码证</div>
                                    <div class="el-upload__tip">如三证合一可不填；若非三证合一请上传组织机构代码证扫描件</div>
                                </template>
                            </el-upload>
                        </el-col>
                        ...
                        <el-col :span="6">
                            <el-upload class="upload-demo" action="https://jsonplaceholder.typicode.com/posts/"
                                :limit="1" :file-list="form.bankAccount">
                                <el-button type="primary">点击上传</el-button>
                                <template #tip>
                                    <div class="el-upload__tip">银行开户许可证</div>
                                    <div class="el-upload__tip">请上传银行开户许可证扫描件</div>
                                </template>
                            </el-upload>
                        </el-col>
                    </el-row>
